import '../reset_active_two_screen/widgets/listlock1_item_widget.dart';
...
class ResetActiveTwoScreen extends GetWidget<ResetActiveTwoController> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.resetActiveTwoModelObj.value
                                  .listlock1ItemList.length,
                              itemBuilder: (context, index) {
                                Listlock1ItemModel model = controller
                                    .resetActiveTwoModelObj
                                    .value
                                    .listlock1ItemList[index];
                                return Listlock1ItemWidget(model);
                              }))),
                      CustomButton(
