...
class CartvtwoItemWidget extends StatelessWidget {
  CartvtwoItemWidget(this.cartvtwoItemModelObj);

  CartvtwoItemModel cartvtwoItemModelObj;

  var controller = Get.find<CartVtwoController>();
