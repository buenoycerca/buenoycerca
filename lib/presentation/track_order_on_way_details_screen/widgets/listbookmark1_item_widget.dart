...
class Listbookmark1ItemWidget extends StatelessWidget {
  Listbookmark1ItemWidget(this.listbookmark1ItemModelObj);

  Listbookmark1ItemModel listbookmark1ItemModelObj;

  var controller = Get.find<TrackOrderOnWayDetailsController>();
