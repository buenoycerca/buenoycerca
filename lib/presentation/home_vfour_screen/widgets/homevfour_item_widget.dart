...
class HomevfourItemWidget extends StatelessWidget {
  HomevfourItemWidget(this.homevfourItemModelObj);

  HomevfourItemModel homevfourItemModelObj;

  var controller = Get.find<HomeVfourController>();
