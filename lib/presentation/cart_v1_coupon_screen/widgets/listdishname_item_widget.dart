...
class ListdishnameItemWidget extends StatelessWidget {
  ListdishnameItemWidget(this.listdishnameItemModelObj);

  ListdishnameItemModel listdishnameItemModelObj;

  var controller = Get.find<CartV1CouponController>();
