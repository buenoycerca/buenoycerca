...
class FavouritevoneItemWidget extends StatelessWidget {
  FavouritevoneItemWidget(this.favouritevoneItemModelObj);

  FavouritevoneItemModel favouritevoneItemModelObj;

  var controller = Get.find<FavouriteVoneController>();
