import '../search_filter_screen/widgets/searchfilter_item_widget.dart';
                      ...
                      Align(
                          ...
                          child: Container(
                              ...
                              child: Obx(() => ListView.separated(
                                  ...
                                  itemCount: controller.searchFilterModelObj
                                      .value.searchfilterItemList.length,
                                  itemBuilder: (context, index) {
                                    SearchfilterItemModel model = controller
                                        .searchFilterModelObj
                                        .value
                                        .searchfilterItemList[index];
                                    return SearchfilterItemWidget(model);
                                  })))),
                      Padding(
                          padding: getPadding(left: 34, top: 41),
