...
class PhoneNumberActiveOneScreen
    extends GetWidget<PhoneNumberActiveOneController> {
  @override
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: controller.group218Controller,
                          ...
                          prefix: Container(
                              ...
                              child: CustomImageView(
                                  svgPath: ImageConstant.imgCallGray500)),
                          prefixConstraints:
