import '../track_order_on_way_details_one_screen/widgets/listbookmark_item_widget.dart';
...
class TrackOrderOnWayDetailsOneScreen
    extends GetWidget<TrackOrderOnWayDetailsOneController> {
  @override
                                                                ...
                                                                child: Obx(() => ListView
                                                                    .separated(
                                                                        ...
                                                                        itemCount: controller
                                                                            .trackOrderOnWayDetailsOneModelObj
                                                                            .value
                                                                            .listbookmarkItemList
                                                                            .length,
                                                                        itemBuilder:
                                                                            (context,
                                                                                index) {
                                                                          ListbookmarkItemModel model = controller
                                                                              .trackOrderOnWayDetailsOneModelObj
                                                                              .value
                                                                              .listbookmarkItemList[index];
